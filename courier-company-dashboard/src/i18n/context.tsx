...
import tgTranslations from "./translations/tg.json";

export type Locale = "en" | "ru" | "tg";

export const LOCALE_KEY = "courier-company-dashboard-locale";
...
const translations = {
  ...
  tg: tgTranslations as Translations,
};
...
export function LanguageProvider({
  ...
  useEffect(() => {
    ...
    if (navLang.startsWith("ru")) setLocaleState("ru");
    else if (navLang.startsWith("tg")) setLocaleState("tg");
  }, []);
